    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            while (flag) {
                ...
                scanner.nextLine();
                if (option == 1) {
                    System.out.println("Total Slots Available: " + parkingLot.getFreeSlotCount());
                } else if (option == 2) {
                    ...
                    if (parkingLot.findVehicle(plate) == null) {
                        ...
                        switch (selected) {
                            ...
                            case 2:
                                ...
                                break;
                            default:
                                throw new Exception("Incorrect Input, Please Select a vehicle");
                        }
                    ...
                    plate = scanner.nextInt();
                    Ticket vehTicket = parkingLot.findTicket(plate);
                    if (vehTicket != null) {
                        System.out.println(vehTicket);
                    } else {
                        System.out.println("\n Vehicle with the ticket: [ " +plate +" ] Not Found");
                    }
                } else if (option == 4) {
                    System.out.println("Enter Plate: ");
                    plate = scanner.nextInt();
